...
import 'package:favourite_places_learning/screens/map.dart';
...
class _LocationInputState extends State<LocationInput> {
  ...
  void _savePlace(double latitude ,double longitude) async {
    final url = Uri.parse(
        'https://maps.googleapis.com/maps/api/geocode/json?latlng=$latitude,$longitude&key=AIzaSyAX6m5zuVHz_yJtpTcfaH8W_ILI0KheQH8');
